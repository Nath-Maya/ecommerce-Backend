...
router.post("/:idCart/products/:idProduct",anyRole, async (req, res) => {
  const idCart = req.params.idCart;
...
router.put("/:idCart/products/:idProduct",anyRole, async (req, res) => {
  const idCart = req.params.idCart;
  const idProduct = req.params.idProduct;
...
router.delete("/:idCart/products/:idProduct", anyRole, async (req, res) => {
  const idCart = req.params.idCart;
  const idProduct = req.params.idProduct;
